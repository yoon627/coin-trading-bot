...
4. **진입 지표를 10종 더 넣어도 답이 바뀌지 않았다** — 탐색을 넓히는 방향의 수확체감이 실측으로 확인된 셈이다. 다음으로 유효한 것은 그리드를 더 뒤지는 게 아니라 **표본을 늘리는 축**이다 — 전향적 관찰(소액 카나리아·페이퍼), 국면 fixture 추가, 또는 M1 fixture([[reset-churn-measurement]] 후속).
