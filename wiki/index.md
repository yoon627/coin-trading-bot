...
- [[take-profit-stop-loss-2026-09]] — 익절×손절 20셀 사전명세 비교(진입일 페어링 maxT, 10창): 통과 9·후보 0. 익절 8·off 는 pooled·하락 창에서 이기지만(일부 창은 음수) 계기 편향 순방향, 손절 off 우위는 진입봉 순서 가정에 2/3 가 걸려 있다. 익절 3·손절 3 은 통과 없이 대부분 열세. 판별은 15분봉 또는 tick 가상 보유
