...
- [[reentry-premium-2026-09]] — #143/#144: 리셋 뒤 같은 날 재진입 프리미엄(5분봉 10창 300쌍) 중앙값 +2.16% 는 대조군 +2.77% 보다 낮아 리셋 고유의 가격 불이익은 없다 — 다만 왕복 비용인 돌파 프리미엄 자체는 남고 D1 반사실은 그것을 0 으로 그린다(≈0.8%p/TIME_EXIT, LIVE_SAME_BAR 로 바꿔도 남는 편향). M1 fixture 불필요
...
- [[entry-resolution-vs-live-2026-09]] — #190 라이브 `combined` 매수 76건 vs 240/15/5분봉 계기: 240분은 recall 0.40·라이브가 0.97%p 싸게 삼(다른 계기), 15분=5분은 같은 진입 집합(64건·F1 0.74)이고 5분이 기록가격에 가장 가깝다(median|Δ| 0.21%p). 사전고정 판정은 F1 동률로 유보. 라이브 전용 24건 중 13건이 09:00 KST 직후 — 리셋 직후 전일 돌파선 진입 가설(미확인)
- [[breakout-entry-filters-2026-09]] — #208 `combined` 진입 필터 9셀(지연 5·10·15분·되밀림 포기·마진 0.25~1%·마감 12h/18h) 5분봉 10창 maxT 사전고정 판정: 통과 0·후보 0, 현행 유지. 지연은 손실 진입을 못 걸러내고(제거 91건 −232 vs 체결가 비용 −233), 마진 1% 는 612건 −964 를 지우되 체결가 +0.84%p 로 −832 를 되돌려줘 순 +132(p 0.064). 진입 축도 이 계기에선 소진
...
- [[external-signal-gate-2026-09]] — 김프·펀딩·공포탐욕·ETH/BTC·테이커 13셀 레짐 게이트(같은 5분봉 계기·사전고정 `ca3242e`): 5분봉에서 전부 양수·FNG_FEAR 통과지만 위상 이동 대조군 21/260 통과(상한 13) → 계기 무효·후보 0. 이득은 정보가 아니라 음수 기준선에서 "덜 거래" 효과 — 재시도 전 5분봉 기준선(#189·#190) 선행
- [[completed-bar-indicators-2026-09]] — #27 J: `combined` 의 MA·RSI 를 완결 일봉만으로 계산하는 3셀(MA·RSI·둘 다) 5분봉 사전고정 판정: 후보 0(격차 −8·−64·−72%p), 셀 규모에 맞춘 전이일 마스크 null N0 0/60 유효. 라이브·계기가 이미 같은 부분봉 의미론이라 결함 아님 — 현행 유지. 현행 부분봉 RSI 가 거르는 진입 146건은 건당 −0.35%p
