...
- ✅ **완료(PR #173)** — 실행 슬리피지 측정 — 결정가 vs 실체결가. #105 계열 정합이 선행돼야 한다. (높음)
- ✅ **완료(2026-09-06)** — 관측 켜기 — 배포 설정(`trading.shadow-exit.enabled=true`). 사람이 결정한다. (사용자)
- ⏳ 이슈 #182 — 마켓 폭 확대 — 8 → 20+ 면 수익 판정 기간이 4.7년 → 약 1.9년. 유니버스 확대는 별개의 리스크 결정이다. (중간)
