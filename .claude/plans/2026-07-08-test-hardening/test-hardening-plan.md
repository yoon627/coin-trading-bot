...
슬라이스 2(CandleAggregator) 구현 green — code-reviewer(+codex)·simplify·전체검증 후 커밋/push/PR. 남은 슬라이스: processTicker seam·죽은 테스트 정리(TradingEngineTest)는 **engine-lifecycle 미머지**라 여전히 대기(Blockers).
